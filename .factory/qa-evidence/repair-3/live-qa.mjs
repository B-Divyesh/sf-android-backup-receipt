...

{
  ...
  await page.screenshot({ path: '.factory/qa-evidence/repair-3/live-desktop-full.png', fullPage: true });
  await context.close();
}

{
  ...
  await page.screenshot({ path: '.factory/qa-evidence/repair-3/live-mobile-demo-full.png', fullPage: true });
  await context.close();
}
